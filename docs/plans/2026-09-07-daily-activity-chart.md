...
Run: `node --import /Users/developer/Documents/ChatGPT/strechly/node_modules/tsx/dist/loader.mjs --test src/lib/timer.test.ts`
...
```bash
node --import /Users/developer/Documents/ChatGPT/strechly/node_modules/tsx/dist/loader.mjs --test src/lib/timer.test.ts
...
```bash
/Users/developer/Documents/ChatGPT/strechly/node_modules/.bin/tauri build --bundles app --config '{"build":{"beforeBuildCommand":""}}'
```
