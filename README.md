...
当前主干为 Rust / Tauri 0.6.3 版本，使用 macOS 自带 WKWebView，开发和打包方法见 [Rust 版说明](README-rust.md)。`electron/` 保留早期实现。

[下载 Mac 预览版 v0.6.3](https://github.com/godosou/outsie/releases/tag/v0.6.3) · [产品主页](https://godosou.github.io/outsie/) · [发布说明](docs/releases/v0.6.3.md)
...
- **3D 拉伸跟练**：大休息会自动轮播 8 个离线 3D 拉伸动作，其中 6 个重点照顾肩颈和上背。左侧放大人物，右侧集中显示动作说明、倒计时与操作按钮；也可手动切换前后动作。短休息新增 6 条护眼知识，每次休息稳定显示一条，读完后把视线移向远处。
