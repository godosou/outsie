...
class PairingCryptoTest {
    ...
    private val wantSasHash = "a25de9292840328d5c634e856328c8251561f688f61c960ce05641e4add8aa46"
    ...
    @Test fun transcriptHashMatchesOpenssl() {
        assertEquals(wantSasHash, hex(PairingCrypto.sasHash(pkM, pkP, nm, np)))
    }

    @Test fun sixDigitsMatchOpenssl() {
        assertEquals(wantDigits, PairingCrypto.sasDigits(PairingCrypto.sasHash(pkM, pkP, nm, np)))
    }
    ...
    @Test fun derivedKeyMatchesOpenssl() {
        ...
        val salt = PairingCrypto.sasHash(pkM, pkP, nm, np)
    ...
    @Test fun aSubstitutedPublicKeyChangesTheDigits() {
        ...
        assertNotEquals(wantDigits, PairingCrypto.sasDigits(PairingCrypto.sasHash(other, pkP, nm, np)))
    }
